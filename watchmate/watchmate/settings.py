...
SECRET_KEY = "django-insecure-vmlvs*)36sz@#v1g_7z%p+0z6hnleq^amjhc)0f2_xh##vnkpp"
...
# grant all privileges on database TESTDB to django;
# create schema restapi;
# ALTER USER django SET search_path = restapi;
